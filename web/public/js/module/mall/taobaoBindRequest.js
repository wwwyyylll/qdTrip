require(["consts", "apis", "utils", "common"], function(consts, apis, utils) {
    ...
    var operates = {
        processed:function(id){
            ...
            utils.ajaxSubmit(apis.taobaoMemberOperationIdBindRequest.getLists, processedParam, function (data) {
                var getByIdData = {
        ...
        waitList:function(){
            ...
            utils.ajaxSubmit(apis.taobaoMemberOperationIdBindRequest.getLists, waitParam, function (data) {
                var getByIdData = {
                    dataArr:data.dataArr,
                    content:content,
                    contentType:contentType?contentType:"昵称"
        ...
        rejectList:function(){
            ...
            utils.ajaxSubmit(apis.taobaoMemberOperationIdBindRequest.getLists, rejectParam, function (data) {
                var getByIdData = {
                    dataArr:data.dataArr,
                    content:content,
                    contentType:contentType?contentType:"昵称"
