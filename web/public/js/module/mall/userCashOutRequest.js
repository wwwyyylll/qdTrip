require(["consts", "apis", "utils", "common"], function(consts, apis, utils) {
    ...
    var operates = {
        processed:function(id){
            ...
            utils.ajaxSubmit(apis.taobaoUserCashOutRequest.getLists, processedParam, function (data) {
                var getByIdData = {
        ...
        waitList:function(){
            ...
            utils.ajaxSubmit(apis.taobaoUserCashOutRequest.getLists, waitParam, function (data) {
                var getByIdData = {
                    dataArr:data.dataArr,
                    content:content,
                    contentType:contentType?contentType:"昵称"
        ...
        rejectList:function(){
            ...
            utils.ajaxSubmit(apis.taobaoUserCashOutRequest.getLists, rejectParam, function (data) {
                var getByIdData = {
                    dataArr:data.dataArr,
                    content:content,
                    contentType:contentType?contentType:"昵称"
        ...
        complete:function($this){
            ...
            hound.confirm('确认打款吗?', '', function () {
                utils.ajaxSubmit(apis.taobaoUserCashOutRequest.completeById, {id: id}, function (data) {
        ...
        reject:function($this){
            ...
            hound.reason('确认驳回吗?','请输入驳回原因',function(data){
                utils.ajaxSubmit(apis.taobaoUserCashOutRequest.rejectById, {id: id,reason:data}, function (data) {
                    hound.success("操作成功", "", 1000);
                    operates.waitList();
                });
            })
