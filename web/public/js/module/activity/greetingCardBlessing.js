require(["consts", "apis", "utils", "common"], function(consts, apis, utils) {
    ...
    $addModal.on("click",function(){
        ...
        utils.renderModal('新增卡片祝福语', template('modalDiv',initialData), function(){
            if($("#visaPassportForm").valid()){
                utils.loading(true);
                utils.ajaxSubmit(apis.greetingCardBlessing.create,$("#visaPassportForm").serialize(),function(data){
                    utils.loading(false);
    ...
    var operates = {
        ...
        edit:function($this){
            ...
            utils.ajaxSubmit(apis.greetingCardBlessing.getById, {id: id}, function (data) {
                var getByIdData = {
                    dataArr:data
                };
                utils.renderModal('编辑卡片祝福语', template('modalDiv', getByIdData), function(){
                    if($("#visaPassportForm").valid()) {
                        utils.loading(true);
                        utils.ajaxSubmit(apis.greetingCardBlessing.updateById, $("#visaPassportForm").serialize(), function (data) {
                            utils.loading(false);
        ...
        setOff:function($this){
            ...
            hound.confirm('确认无效吗?', '', function () {
                utils.ajaxSubmit(apis.greetingCardBlessing.offById, {id: id}, function (data) {
                    loadData();
                });
            });
        },
        ...
        setOn:function($this){
            ...
            hound.confirm('确认有效吗?', '', function () {
                utils.ajaxSubmit(apis.greetingCardBlessing.onById, {id: id}, function (data) {
                    loadData();
                });
            });
        }
    ...
    function loadData() {
        utils.ajaxSubmit(apis.greetingCardBlessing.getLists, param, function (data) {
